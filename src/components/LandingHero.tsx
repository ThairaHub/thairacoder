...
import { TrendingUp, MessageSquare, Users, BarChart3, ArrowRight, Sparkles } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Click on any trend to generate content instantly</p>
          </div>
